...
(def mongodb-uri (or (env :obb-mongo-uri) "mongodb://127.0.0.1/obb?maxPoolSize=128&waitQueueMultiple=5;waitQueueTimeoutMS=150;socketTimeoutMS=5500&autoConnectRetry=true;safe=false&w=1;wtimeout=2500;fsync=true"))
